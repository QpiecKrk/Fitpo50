...
<main class="day-list-page">
  <div class="container">
    ...
    <div class="day-list-grid">
      ...
      <a href="<?= htmlspecialchars($e['html_file']) ?>" class="entry-card reveal">
    ...
    <div style="text-align:center;margin-top:var(--space-12);">
      <a href="moje-sukcesy.html" class="btn btn--outline" style="border-color:var(--color-primary);color:var(--color-primary);">
        ← Wróć do kalendarza
      </a>
    </div>
  </div>
